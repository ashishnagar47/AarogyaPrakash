    ...
    <div>
        <footer className="footer" style={{bottom:"0",position:"relative"}}>
            ...
            <div className="footer-right col-md-6 col-sm-6">
                ...
                <p className="menu" >
                <a href="#" style={{marginRight:"20px", color:" rgb(0, 60, 255)"}}> 
                ...
                <a href="/CreateTreatment" style={{marginRight:"20px", color:" rgb(0, 60, 255)"}}> 
                ...
                <a href="/CreateEvent" style={{marginRight:"20px", color:" skyblue"}}> 
                ...
                <a href="/CreateBlog" style={{marginRight:"20px", color:" red"}}> 
                ...
                <a href="/contactus" style={{marginRight:"20px", color:" red"}}> 
                ...
                <a href="/contactus" style={{color:"green"}}> 
