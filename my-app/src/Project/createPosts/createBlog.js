    ...
    return (
        ...
        textAlign:"center"}}>
            <div className="mb-3" style={{marginTop:"00px", padding:"50px 0 0 00px"}}>
                ...
                <label htmlFor="exampleInputEmail1"  style={{textAlign:"left"}}>Blog Title</label>
            ...
            <div className="mb-3 " style={{marginTop:"00px", padding:"00px 00px 00px 00px"}}>
                <label htmlFor="floatingTextarea">Blog Body</label>
                <textarea className="form-control" placeholder="Add content for this Blog" id="floatingTextarea" value={body} onChange={(e)=>setBody(e.target.value)}></textarea>   
            </div>
